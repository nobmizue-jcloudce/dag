...
args = {
    "project_id": "hello-kubeflow-0519023040",
}

dag = DAG(
    "hello-kubeflow-0519023040",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using hello-kubeflow.pipeline.",
...
notebook_op_c388e580_846f_4394_91a5_fe95d060b5da = NotebookOp(
    ...
    cos_directory="hello-kubeflow-0519023040",
